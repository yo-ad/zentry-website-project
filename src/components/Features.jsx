...
// https://www.youtube.com/watch?v=zA9r5zTllx4&t=6683s
      ...
      <div className='container mx-auto px-3 md:px-10'>
        <div className='px-5 py-32'>
          ...
          <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
            ...
            array of products converge into an
        ...
        <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
          <div className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
            <BentoCard
              ...
              title={<>zigma</>}
              description="An anime and gaming-inspired collection - 
              the IP rimed for expansion."
              isComingSoon
            />
          </div>
          <div className='bento_tilt_1 row-span-1 ms-32
          ...
          <div className='bento_tilt_1 me-14 md:col-span-1 md:me-0'>
            <BentoCard
              ...
              title={<>az<b>u</b>re</>}
              description="A cro0ss-world AI Agent - elevating your
          ...
          bg-violet-300 p-5'>
              ...
              text-black'>M<b>o</b>re co<b>m</b>ing s<b>o</b>on!</h1>
